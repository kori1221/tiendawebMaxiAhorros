...
$sql = $con->prepare("SELECT id, nombre, precio FROM productost WHERE categoriaP=5");
$sql->execute();
          ...
          <li class="nav-item">
            <div class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="http://localhost/Proyecto%20MaxiAhorros%20K/decoracion.php">Decoracion</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
