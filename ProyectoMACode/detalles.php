...
if($id == '' || $token == ''){
    ...
    if ($token == $token_tmp){ 
        $sql = $con->prepare("SELECT count(id) FROM productoso WHERE id=? AND tipo=1");
        $sql->execute([$id]);
        if($sql->fetchColumn() > 0){
            $sql = $con->prepare("SELECT nombre, descripcion, precio, descuento FROM productoso WHERE id=? AND tipo=1
            LIMIT 1");
            $sql->execute([$id]);
            ...
            $dir_images = 'imagenes_ofertas/' . $id . '/';
      ...
      <td class="barraNav">
        <nav class="navbar navbar-expand-lg bg-primary">
          <div class="container-fluid">
            <a class="navbar-brand text-secondary" href="http://localhost/Proyecto%20MaxiAhorros%20K/index.php" id="Inicio">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              Inicio&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link text-secondary" href="http://localhost/Proyecto%20MaxiAhorros%20K/sucursales.php"
                    id="Sucursales">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sucursales&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link text-success" href="http://localhost/Proyecto%20MaxiAhorros%20K/ofertas.php"
                    id="Ofertas">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Ofertas</b>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                </li>
                <li class="nav-item">
        ...
        <div class="row">
            ...
            <div class="col-md-6 order-md-2">
              ...
              <?php if ($descuento >0 ) { ?>
                ...
                <small class="text-secondary"><?php echo $descuento; ?> % de descuento</small>
                </h2>
              <?php } else { ?>
